 ...
 */
const TasksLayer = ({ setTaskTooltip, taskTooltip, create, onTaskEvent }) => {
    const { columnWidth, drawRange, interval: { start: intervalStart, end: intervalEnd }, resolution, resources, rowHeight, tasks, toolTip, workTime } = (0, TimelineContext_1.useTimelineContext)();
    ...
    return (react_1.default.createElement(react_konva_1.Layer, null,
        tasks.map((taskData) => {
            ...
            return (react_1.default.createElement(Task_1.default, { key: `task-${taskData.id}`, data: taskData, fill: resourceColor, fillToComplete: toCompleteColor, onLeave: onTaskLeave, onOver: onTaskOver, x: xCoordinate, y: yCoordinate, width: width, disabled: create, onTaskEvent: onTaskEvent }));
        }),
        toolTip && taskTooltip && react_1.default.createElement(Tooltip_1.default, Object.assign({}, taskTooltip))));
};
exports.default = TasksLayer;
