...
export declare const TaskDocs: ({ data, fill, onLeave, onOver, x, y, width, fillToComplete, disabled, onTaskEvent, }: TaskProps) => React.JSX.Element;
declare const _default: React.MemoExoticComponent<({ data, fill, onLeave, onOver, x, y, width, fillToComplete, disabled, onTaskEvent, }: TaskProps) => React.JSX.Element>;
