...
const GridRow = ({ index }) => {
    const { drawRange: { start: drawRangeStart, end: drawRangeEnd }, rowHeight, theme: { color: themeColor }, } = (0, TimelineContext_1.useTimelineContext)();
    const yPos = (0, react_1.useMemo)(() => rowHeight * (index + 1), [index, rowHeight]);
    ...
    return (react_1.default.createElement(_konva_1.KonvaGroup, null,
        react_1.default.createElement(_konva_1.KonvaLine, { points: [drawRangeStart, yPos, drawRangeEnd, yPos], stroke: stroke }),
        react_1.default.createElement(_konva_1.KonvaRect, { x: drawRangeStart, y: yPos, width: drawRangeEnd - drawRangeStart, height: rowHeight, fill: fill })));
};
